...
Aplikasi ini membuat segmentasi **Pelanggan pada perusahaan pernerbangan**!, 
...
jumlah_cluster = st.sidebar.selectbox('Tentukan Jumlah Cluster :',(5,2,3,4,5,6,7,8,9,10))
